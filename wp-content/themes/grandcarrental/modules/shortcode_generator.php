...
add_action('admin_menu', 'grandcarrental_shortcode_generator');

function grandcarrental_shortcode_generator() 
{  
	if ( function_exists('add_meta_box') ) {  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandcarrental_shortcode_generator_options', 'page', 'normal', 'default' );
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandcarrental_shortcode_generator_options', 'post', 'normal', 'default' );  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandcarrental_shortcode_generator_options', 'car', 'normal', 'default' );
	}
}

function grandcarrental_shortcode_generator_options() {
	...
	grandcarrental_aasort($shortcodes,"name");
