...
<div id="page_caption">
	<div class="page_title_wrapper">
		<div class="page_title_inner">
		    <h1><?php esc_html_e('404 Not Found!', 'grandcarrental' ); ?></h1>
		    <div class="page_tagline">
		        <?php esc_html_e( "We're sorry, the page you have looked for does not exist in our content!", 'grandcarrental' ); ?>
		    </div>
		</div>
	</div>
</div>
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
	    	...
	    	<div class="search_form_wrapper">
		    	<?php esc_html_e( "Perhaps you would like to go to our homepage or try searching below.", 'grandcarrental' ); ?><br/><br/>
		    	
	    		<form class="searchform" method="get" action="<?php echo esc_url(home_url('/')); ?>">
			    	<input style="width:100%" type="text" class="field searchform-s" name="s" value="<?php the_search_query(); ?>" placeholder="<?php esc_html_e('Type to search and hit enter...', 'grandcarrental' ); ?>">
			    </form>
    		</div>
	    	
	    	<br/>
	    	
	    	<h5><?php esc_html_e('Or try to browse our latest posts instead?', 'grandcarrental' ); ?></h5><br/>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="post_wrapper grid_layout">
					    ...
					    <div class="post_header_wrapper">
							...
							<?php
							    echo grandcarrental_substr(get_the_excerpt(), 80);
							?>
							
							<div class="post_button_wrapper">
							    <a class="readmore" href="<?php the_permalink(); ?>"><?php echo esc_html_e('Read More', 'grandcarrental' ); ?><span class="ti-angle-right"></span></a>
							</div>
					    </div>
