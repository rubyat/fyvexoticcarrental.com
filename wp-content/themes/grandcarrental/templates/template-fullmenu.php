...
<div class="mobile_menu_wrapper">
	<div class="fullmenu_wrapper">
		...
		<form method="get" name="searchform" id="searchform" action="<?php echo esc_url(home_url('/')); ?>/">
		    <div>
		    	<input type="text" value="<?php the_search_query(); ?>" name="s" id="s" autocomplete="off" placeholder="<?php esc_html_e('Search...', 'grandcarrental' ); ?>"/>
		    	<button>
	    ...
	    <?php
			...
			$tg_topbar_social_link = kirki_get_option('tg_footer_social_link');
		?>
...
<?php
	...
	grandcarrental_set_page_menu_transparent($page_menu_transparent);
?>
<!-- End mobile menu -->