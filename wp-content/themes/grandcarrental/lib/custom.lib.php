...
function grandcarrental_get_site_domain()
{
	$site_url = site_url();
...
if(!function_exists('grandcarrental_is_registered'))
{
	function grandcarrental_is_registered() {
		$grandcarrental_is_registered = get_option("envato_purchase_code_".ENVATOITEMID);
		
		if(!empty($grandcarrental_is_registered)) {
...
function grandcarrental_register_theme($purchase_code = '') {
...
function grandcarrental_unregister_theme() {
